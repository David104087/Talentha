...
PLAN_CONTENT mapea (id_dimensión, nivel) → dict con claves:
  supervisor : list[str]  – acciones para el supervisor
  jefe       : list[str]  – acciones para el jefe directo
  sistema    : list[str]  – acciones sistémicas / organizacionales
  kpi        : list[str]  – indicadores clave (se unen con ' · ' en la salida final)

Solo D4-critico y D1-critico contienen texto real (requisito del enunciado,
sección 2.1). El resto de combinaciones se genera con placeholder en
plan_intervencion._construir_acciones.
"""
